...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="{{ '/assets/img/publication_preview/BMGEMM-intro.png' | relative_url }}" alt="Introduction" class="img-fluid rounded z-depth-1">
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img src="{{ '/assets/img/publication_preview/BMGEMM-multiblock.png' | relative_url }}" alt="BM GEMM for local block" class="img-fluid rounded z-depth-1">
    </div>
</div>
<div class="caption">
